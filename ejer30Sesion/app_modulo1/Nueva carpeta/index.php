            ...
            function muestraImg(valor) {
                ...
                $.ajax({
                    ...
                    success:function (respServ)
                    {
                        ...
                        $("#IMG").html("<iframe width='100%' height='100%' src='data:image/jpg;base64,"+imagenJson.imagenVehiculo+"'></iframe>");
                    }
                })                
            }                 
